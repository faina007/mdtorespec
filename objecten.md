...
| --------------- | ------------------------------------------------------------- | --------- | ----------- | ------------ |
| `identificatie` | Gegevens waarmee  het object geïdentificeerd kan worden.      | Ja        | Ja          | `xsd:string` |
| `naam`          | Een betekenisvolle aanduiding waaronder het object bekend is. | Ja        | Nee         | `xsd:string` |
